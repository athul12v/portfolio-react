...
const profile = {
    name: 'ATHUL V',
    title: 'Software Engineer | AI & Cloud Solutions Architect | ML Enthusiast',
    skills: [
      'React', 'Angular', 'Python Flask', 'WebRTC',
      'Docker', 'LLM/NLP', 'CNN/ML', 'AI',
      'MongoDB', 'PostgreSQL', 'Redis',
      'Android Studio', 'Git', 'Linux',
      'Azure', 'Copilot Studio', 'PowerApps'
]
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
  ...
  const handleDownloadResume = () => {
    const resumeUrl = '/Athul_V_Data_Scientist.pdf';
    const link = document.createElement('a');
    link.href = resumeUrl;
    link.download = 'Athul_V_Data_Scientist.pdf';
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              {/* <div className="flex gap-4 mb-8">
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 text-white font-medium hover:from-blue-600 hover:to-purple-600 transition-all"
                >
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                ...
                MCA Grad 🎓 | Passionate About Data Science & AI 🤖 | 
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/athul12v"
                ...
                {/* Contact Button */}
                <a
                  href="/Athul_V_Data_Scientist.pdf"
                  download="Athul_V_Data_Scientist.pdf"
